...
export class HomeKidsComponent implements OnInit {
  ...
  kidProducts: Product[] = [];
  girlIcons: any[] = [
    { id: "5a1b8c5850a7e177459200eb", name: "Áo thun", srcIcon: "../../assets/images/icons/g-shirt.png" },
    ...
    { id: "5a1b8c8350a7e177459200ee", name: "Đầm", srcIcon: "../../assets/images/icons/g-dress.png" },
    { id: "5a1b8c9550a7e177459200ef", name: "Quần + Váy", srcIcon: "../../assets/images/icons/g-skirt.png" },
    { id: "5a1b8ca150a7e177459200f0", name: "Set + Đồ bộ", srcIcon: "../../assets/images/icons/b-set.png" }
  ];
  boyIcons: any[] = [
    { id: "5a1b8c5850a7e177459200eb", name: "Áo thun", srcIcon: "../../assets/images/icons/b-shirt.png" },
    { id: "5a1b8c6750a7e177459200ec", name: "Áo sơmi", srcIcon: "../../assets/images/icons/b-balo.png" },
    { id: "5a1b8c7450a7e177459200ed", name: "Áo khoác", srcIcon: "../../assets/images/icons/g-shirt.png" },
    { id: "5a1b8c9550a7e177459200ef", name: "Quần", srcIcon: "../../assets/images/icons/b-short.png" },
    { id: "5a1b8ca150a7e177459200f0", name: "Đồ bộ", srcIcon: "../../assets/images/icons/b-set.png" }
  ]
